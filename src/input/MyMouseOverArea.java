 ...
 * @author kevin
 * @author Kristof
 based on MyMouseOverArea
 * @see org.newdawn.slick.gui.MouseOverArea
 */
public class MyMouseOverArea extends AbstractComponent {
    ...
    protected Color mouseOverColor = Color.white;

    /** The colour used in mouseDown state */
    protected Color mouseDownColor = Color.white;

    /** The sound for mouse over */
    protected Sound mouseOverSound;

    /** The sound for mouse down */
    protected Sound mouseDownSound;
